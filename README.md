...
[![npm](https://img.shields.io/npm/v/peasy-qr-embed)](https://www.npmjs.com/package/peasy-qr-embed)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
[![Zero Dependencies](https://img.shields.io/badge/dependencies-0-brightgreen)](https://www.npmjs.com/package/peasy-qr-embed)
[![Size](https://img.shields.io/badge/gzipped-<8KB-green)](https://bundlephobia.com/package/peasy-qr-embed)

Embed **PeasyQR** widgets on any website or blog. QR code generation, scanning, and customization tools. Each widget is completely isolated via **Shadow DOM**, requires **zero dependencies**, and supports **3 built-in themes** (light, dark, sepia). The self-executing script finds all `data-peasy-qr` elements on the page and renders interactive widgets automatically, including support for dynamically added elements in single-page applications via MutationObserver.

PeasyQR is part of the [Peasy Tools](https://peasytools.com) ecosystem, providing 11 widget types for embedding file format information, tool cards, conversion guides, glossary terms, search boxes, and interactive tools directly into your pages.

> **Try the interactive widget builder at [widget.peasyqr.com](https://widget.peasyqr.com)** -- build, preview, and copy embed code for any widget type.

<p align="center">
  <img src="demo.gif" alt="peasy-qr-embed demo -- embed peasyqr widgets with Shadow DOM isolation and theme support" width="800">
</p>
...
<div data-peasy-qr="tool"
  data-slug="qr-generator"
  data-theme="light">
</div>
...
That's it. The script will find all `data-peasy-qr` elements, fetch data from the PeasyQR API, and render each widget with full Shadow DOM style isolation.

## Widget Types

PeasyQR supports 11 widget types -- 11 common types available on all Peasy sites.

| Type | Description | Usage |
|------|-------------|-------|
| `format` | File format info card with specs, MIME type, and use cases | `<div data-peasy-qr="format" data-slug="..."></div>` |
| `tool` | Tool card with description and direct launch link | `<div data-peasy-qr="tool" data-slug="..."></div>` |
| `convert` | Conversion card showing input/output format pair | `<div data-peasy-qr="convert" data-slug="..."></div>` |
| `compare` | Side-by-side comparison of two formats or tools | `<div data-peasy-qr="compare" data-slug="..."></div>` |
| `glossary` | Glossary term tooltip with definition on hover | `<div data-peasy-qr="glossary" data-slug="..."></div>` |
| `gallery` | Grid gallery of available tools for a category | `<div data-peasy-qr="gallery" data-slug="..."></div>` |
| `guide` | Guide/tutorial card with summary and read-more link | `<div data-peasy-qr="guide" data-slug="..."></div>` |
| `usecase` | Use-case card showing when and why to use a tool | `<div data-peasy-qr="usecase" data-slug="..."></div>` |
| `badge` | Inline badge showing format type or tool category | `<div data-peasy-qr="badge" data-slug="..."></div>` |
| `search` | Search box with autocomplete for tools and formats | `<div data-peasy-qr="search" data-slug="..."></div>` |
| `interactive` | Embedded interactive tool via iframe | `<div data-peasy-qr="interactive" data-slug="..."></div>` |
...
|-----------|--------|---------|-------------|
| `data-peasy-qr` | format, tool, convert, compare, glossary, gallery, guide, usecase, badge, search, interactive | *required* | Widget type to render |
...
<div data-peasy-qr="tool" data-slug="qr-generator" data-theme="light"></div>

<!-- Dark theme -- dark background, light text -->
<div data-peasy-qr="tool" data-slug="qr-generator" data-theme="dark"></div>

<!-- Sepia theme -- warm, paper-like appearance -->
<div data-peasy-qr="tool" data-slug="qr-generator" data-theme="sepia"></div>

<!-- Auto theme -- follows prefers-color-scheme -->
<div data-peasy-qr="tool" data-slug="qr-generator" data-theme="auto"></div>
```

Each theme sets CSS custom properties inside the Shadow DOM. The accent color (`#2563EB`) is consistent across all themes, providing brand recognition for PeasyQR.
...
```html
<script type="module">
  import 'https://cdn.jsdelivr.net/npm/peasy-qr-embed@1/dist/embed.esm.js';
</script>
```
...
```html
<!-- PeasyQR format info card with light theme -->
<div data-peasy-qr="format" data-slug="qr-generator" data-theme="light"></div>
<script src="https://cdn.jsdelivr.net/npm/peasy-qr-embed@1/dist/embed.min.js"></script>
```
...
```html
<!-- Search across PeasyQR tools and formats -->
<div data-peasy-qr="search"
  data-placeholder="Search PeasyQR tools..."
  data-theme="light">
</div>
<script src="https://cdn.jsdelivr.net/npm/peasy-qr-embed@1/dist/embed.min.js"></script>
```
...
```html
<p>This file is in <div data-peasy-qr="badge" data-slug="qr-generator"></div> format.</p>
<script src="https://cdn.jsdelivr.net/npm/peasy-qr-embed@1/dist/embed.min.js"></script>
```
...
```html
<div data-peasy-qr="glossary" data-slug="lossless" data-theme="light"></div>
<script src="https://cdn.jsdelivr.net/npm/peasy-qr-embed@1/dist/embed.min.js"></script>
```
...
- **CORS**: PeasyQR API has CORS enabled for all origins
...
- **Powered by**: Each widget includes a subtle "PeasyQR" backlink in the footer

## Learn More

Visit [peasyqr.com](https://peasyqr.com) for the full PeasyQR experience.

- **All Tools**: [peasyqr.com](https://peasyqr.com)
- **Formats**: [peasyqr.com/formats/](https://peasyqr.com/formats/)
- **Glossary**: [peasyqr.com/glossary/](https://peasyqr.com/glossary/)
- **Guides**: [peasyqr.com/guides/](https://peasyqr.com/guides/)
- **API Documentation**: [peasyqr.com/developers/](https://peasyqr.com/developers/)
- **OpenAPI Spec**: [peasyqr.com/api/openapi.json](https://peasyqr.com/api/openapi.json)
- **Widget Builder**: [widget.peasyqr.com](https://widget.peasyqr.com)
- **npm Package**: [npmjs.com/package/peasy-qr-embed](https://www.npmjs.com/package/peasy-qr-embed)
...
Embed [PeasyQr](https://peasyqr.com) widgets on any website with [peasy-qr-embed](https://widget.peasyqr.com):

```html
<script src="https://cdn.jsdelivr.net/npm/peasy-qr-embed@1/dist/embed.min.js"></script>
<div data-peasyqr="entity" data-slug="example"></div>
```

Zero dependencies · Shadow DOM · 4 themes (light/dark/sepia/auto) · [Widget docs](https://widget.peasyqr.com)
